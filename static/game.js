...
socket.on('state', function(players,bullets, walls) {
  ...
  Object.values(players).forEach((player) => {
    ...
    context.font = '10px Bold Aroal';
    context.fillStyle = "gray";
    context.fillText('❤︎'.repeat(player.maxHealth), player.x, player.y + player.height + 10);
    context.fillStyle = "red";
    context.fillText('❤︎'.repeat(player.health), player.x, player.y + player.height + 10);
